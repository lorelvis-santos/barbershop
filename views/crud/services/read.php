...
<h1 class="page__name">Servicios</h1>
<p class="page__description">Administra los servicios existentes</p>

<div class="crud-actions">
    <a href="/administracion/servicios/crear" class="crud-action button">Nuevo servicio</a>
</div>
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($services as $service) { ?>
                <tr data-id="<?php echo escape_html($service["id"]); ?>">
                    <td><?php echo escape_html($service["id"]); ?></td>
                    <td><?php echo escape_html($service["name"]); ?></td>
                    <td>RD$<?php echo escape_html($service["price"]); ?></td>
                    <td><?php echo escape_html($service["roleName"]); ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
...
<div class="menu-popup" id="menuPopup">
    <button onclick="updateItem('servicios')">
    ...
    <button onclick="deleteItem('services')">
