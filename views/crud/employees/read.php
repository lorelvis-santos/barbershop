...
<h1 class="page__name">Empleados</h1>
<p class="page__description">Administra los empleados existentes</p>

<div class="crud-actions">
    <a href="/administracion/empleados/crear" class="crud-action button">Nuevo empleado</a>
</div>
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($employees as $employee) { ?>
                <tr data-id="<?php echo escape_html($employee["id"]); ?>">
                    <td><?php echo escape_html($employee["id"]); ?></td>
                    <td><?php echo escape_html($employee["fullName"]); ?></td>
                    <td><?php echo escape_html($employee["email"]); ?></td>
                    <td><?php echo escape_html($employee["phone"]); ?></td>
                    <td><?php echo escape_html($employee["roleName"]); ?></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
...
<div class="menu-popup" id="menuPopup">
    <button onclick="updateItem('empleados')">
    ...
    <button onclick="deleteItem('employees')">
